...
var (
	...
	FeederDelegationKeyPrefix = []byte{0x04}
	...
	AggregateVoteKeyPrefix = []byte{0x06}

	// PrevoteKeyPrefix is the prefix for prevote store keys
	PrevoteKeyPrefix = []byte{0x07}
