...
var (
	...
	ErrMaxPoolsReached = sdkerrors.Register(ModuleName, 28, "maximum number of pools reached")
	...
	// ErrSlippageExceeded is returned when slippage exceeds tolerance on cross-chain execution
	ErrSlippageExceeded = sdkerrors.Register(ModuleName, 25, "slippage exceeded")

	// ErrOraclePrice is returned when oracle price retrieval fails or is stale
	ErrOraclePrice = sdkerrors.Register(ModuleName, 26, "oracle price error")
...
var RecoverySuggestions = map[error]string{
	...
	ErrSlippageExceeded: "Cross-chain slippage exceeded configured tolerance. Route execution was halted. Retry with smaller size or updated slippage limits after liquidity refresh.",
