	...
	tests := []struct {
	...
	}{
		{
			...
			msg: types.MsgSwap{
				...
				MinAmountOut: sdk.NewInt(900000),
			},
			wantErr: false,
		},
		{
	...
	tests := []struct {
	...
	}{
		{
			...
			msg: types.MsgRemoveLiquidity{
				Provider:        "paw1provider",
				PoolId:          1,
				LiquidityTokens: sdk.NewInt(1000000),
				MinAmountA:      sdk.NewInt(900000),
				MinAmountB:      sdk.NewInt(1800000),
			},
			wantErr: false,
		},
		{
		...
		{
			name: "negative min amount A",
			msg: types.MsgRemoveLiquidity{
				Provider:        "paw1provider",
				PoolId:          1,
				LiquidityTokens: sdk.NewInt(1000000),
				MinAmountA:      sdk.NewInt(-1),
				MinAmountB:      sdk.NewInt(1800000),
			},
			wantErr: true,
		},
