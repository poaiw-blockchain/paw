...
require (
	...
	gopkg.in/yaml.v2 v2.4.0 // indirect; transitive dependency from cosmos-sdk and cometbft for config parsing
)
...
replace (
	...
	example.com/bytedance/sonic => github.com/bytedance/sonic v1.14.2
