...
func buildDexKeeper(t testing.TB) (*keeper.Keeper, bankkeeper.Keeper, sdk.Context) {
	...
	fundAddrs := []sdk.AccAddress{
		...
		sdk.AccAddress([]byte("provider_address__")),
		sdk.AccAddress([]byte("provider1_address_")),
		sdk.AccAddress([]byte("provider2_address_")),
		sdk.AccAddress([]byte("attacker_address___")),
		sdk.AccAddress([]byte("attacker_address__")),
