...
- `GET /api/v1/dex/pools/:id/price-history` - Get OHLCV price history
- `GET /api/v1/dex/pools/:id/liquidity-chart` - Get TVL over time
- `GET /api/v1/dex/pools/:id/volume-chart` - Get volume trends
- `GET /api/v1/dex/pools/:id/fees` - Get fee breakdown
- `GET /api/v1/dex/pools/:id/apr-history` - Get APR history
- `GET /api/v1/dex/pools/:id/depth` - Get liquidity depth
- `GET /api/v1/dex/pools/:id/statistics` - Get aggregated statistics
- `GET /api/v1/dex/trades` - Get all trades
- `GET /api/v1/dex/trades/latest` - Get latest trades
- `GET /api/v1/dex/analytics/summary` - Get DEX-wide analytics
- `GET /api/v1/dex/analytics/top-pairs` - Get top trading pairs
- `POST /api/v1/dex/simulate-swap` - Simulate swap execution
- `GET /api/v1/accounts/:address/dex-positions` - Get user LP positions
- `GET /api/v1/accounts/:address/dex-history` - Get user DEX activity
- `GET /api/v1/accounts/:address/dex-analytics` - Get user DEX analytics
