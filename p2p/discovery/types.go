...
type DiscoveryConfig struct {
	...
	// Node identity
	ChainID     string // Chain identifier for handshake validation
	NodeKeyFile string // Path to node's P2P private key file
	NodeID      string // Node's derived ID from P2P key
}
