...
if ! command_exists nancy; then
    ...
    if [ "$MACHINE" == "Linux" ]; then
        ...
        echo -e "${YELLOW}Please install nancy manually: https://github.com/sonatype-nexus-community/nancy${NC}"
    fi
else
...
if ! command_exists trivy; then
    ...
    echo -e "${YELLOW}Install Trivy: https://aquasecurity.github.io/trivy/${NC}"
    if [ "$MACHINE" == "Mac" ]; then
        echo -e "${YELLOW}Quick install: brew install trivy${NC}"
    elif [ "$MACHINE" == "Linux" ]; then
        echo -e "${YELLOW}Quick install: https://aquasecurity.github.io/trivy/latest/getting-started/installation/${NC}"
    fi
else
...
if ! command_exists gitleaks; then
    ...
    echo -e "${YELLOW}Install GitLeaks: https://github.com/gitleaks/gitleaks${NC}"
    if [ "$MACHINE" == "Mac" ]; then
        echo -e "${YELLOW}Quick install: brew install gitleaks${NC}"
    elif [ "$MACHINE" == "Linux" ]; then
        echo -e "${YELLOW}Quick install: https://github.com/gitleaks/gitleaks#installing${NC}"
    fi
else
