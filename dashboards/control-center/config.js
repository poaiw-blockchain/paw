...
export const CONFIG = {
    networks: {
        local: {
            ...
            chainId: 'paw-local-1',
            faucetUrl: 'http://localhost:11050',
            explorerUrl: 'http://localhost:11080',
        ...
        mainnet: {
            ...
            analyticsUrl: 'https://explorer.paw.network/api/v1/analytics',
            features: {
                reset: false,
                fullControl: false,
                faucet: false,
    ...
    analytics: {
        ...
        dexAnalytics: '/dex-analytics',
        addressGrowth: '/address-growth',
        gasAnalytics: '/gas-analytics',
    ...
    auth: {
        enabled: true,
        jwtSecret: process.env.JWT_SECRET || 'paw-dashboard-secret-change-in-production',
        jwtExpiry: '24h',
        refreshTokenExpiry: '7d',
        tokenStorageKey: 'paw_auth_token',
        refreshStorageKey: 'paw_refresh_token'
    },
    ...
    rbac: {
        roles: {
            admin: {
                permissions: ['read', 'write', 'delete', 'manage_users', 'network_control']
            },
            operator: {
                permissions: ['read', 'write', 'network_control']
            },
            viewer: {
                permissions: ['read']
            }
